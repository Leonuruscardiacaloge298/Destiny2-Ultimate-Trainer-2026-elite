...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-elite.WebUI")

class WebUI:
    def __init__(self, trainer: TrainerCore, port=4208):
...
<html>
<head>
    <title>Destiny2-Ultimate-Trainer-2026-elite Dashboard</title>
    <style>
        body { background: #1a1a2e; color: #a93226; font-family: sans-serif; }
...
<body>
    <h1>Destiny2-Ultimate-Trainer-2026-elite</h1>
    <div id="features"></div>
    <script>
