...
log = logging.getLogger("Destiny2-Ultimate-Trainer-2026-elite.GUI")

class TrainerGUI(ctk.CTk):
    def __init__(self, trainer: TrainerCore):
        super().__init__()
        self.trainer = trainer
        self.title("Destiny2-Ultimate-Trainer-2026-elite 3.0.0")
    ...
    def create_widgets(self):
        ctk.CTkLabel(self, text="Destiny2-Ultimate-Trainer-2026-elite", font=("Segoe UI", 24, "bold")).pack(pady=20)
...
def create_tray_icon(gui):
    img = Image.new('RGB', (64,64), color=(169, 50, 38))
    ...
    return pystray.Icon("trainer", img, "Destiny2-Ultimate-Trainer-2026-elite", menu)
